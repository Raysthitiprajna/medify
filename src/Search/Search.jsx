...
export default function Search(){
    ...
    const availableSlots ={
        morning:["11:30 AM"],
        afternoon:["12.00 PM", "12:30PM", "01:30PM", "02.00PM", "02:30PM"],
        evening:["06:00PM", "06:30PM", "07:00PM", "07.30PM"],
    };
    ...
    return (
        ...
        <Box sx={{ background:"linear-gradient(#EFF5FE,rgba(241,247,255,0.47))",width:"100%" , pl:0}}>
            <Box sx={{position:"relative",
                background:"linear-gradient(90deg,#2AA7FF,#0C8CE5)",borderBottomLeftRadius:"1rem",
            ...
            <Modal open ={isModalOpen} setOpen={setIsModalOpen} bookingDetails={bookingDetails} showSuccessMessage ={setShowBookingSuccess}/>
