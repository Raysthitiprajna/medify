...
export default function DaySelector({
    selectedDate,setSelectedDate,totalSlots
}){
    ...
    return (
        <Stack pt={3} position="relative">
            ...
            >
                {dateItems.map((day,index) => (
                    <SwiperSlide key={index} className={styles.SwiperSlide}>
                        ...
                        <Box height={{xs:"4px",md:"5px"}} width={{xs:"1",md:"calc(100%-50px"}}
                        position="relative" bottom="0" bgcolor={isEqual(day,selectedDate) ? "primary.main" : "rgba(0,0,0,0)"} left={0} zIndex={999} mt="5px" mx="auto">
            ...
            <Box height={{xs:"4px",md:"5px"}} width={{xs:1,md:"calc(100% - 150px)"}}
            bgcolor="#F0F0F5" mt="5px" position="absolute" bottom={0} left="50%" sx={{translate:" -50% 0"}}>
