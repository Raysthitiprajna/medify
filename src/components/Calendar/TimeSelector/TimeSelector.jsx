...
export default function TimeSelector({
    availableSlots,details,handleBooking,selectedDate
}){
    const CustomChip =(props) => (
        <Chip label={props.label} color="primary" variant="outlined" sx={{
            borderRadius:"5px",
