import {Box,Container,container,Grid,Stack,Typography} from "@mui/material";
                    ...
                    <Grid container spacing={4}>
                        ...
                        <Grid item xs={12} md={2.5}>
                            <Stack spacing={2}>
                                ...
                                <FooterLink>Outer Gallery</FooterLink>
                         ...
                         <Grid item xs={12} md={2.5}>
                            <Stack spacing={2}>
                                ...
                                <FooterLink>Opthamology</FooterLink>
                                <FooterLink>Cardiology</FooterLink>
                            </Stack>
                        </Grid>
                    </Grid>
                    <Typography fontWeight={300} color="#fff"
                    fontSize={14}
                    pt={3}
                    mt={5}
